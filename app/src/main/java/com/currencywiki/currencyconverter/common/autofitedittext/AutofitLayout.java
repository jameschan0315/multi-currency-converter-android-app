package com.currencywiki.currencyconverter.common.autofitedittext;
...
/**
 * <p>A {@link ViewGroup} that re-sizes the text of it's children to be no larger than the width of the
 * view.
 *
